...
const CSVLink = () =>  (
  <div className="container">
    <h2>
      Report Complete! The CPU report takes longer to generate, it will be emailed to you around an hour.
    </h2>
    ...
    <React.Fragment>
      ...
      <main>
        ...
        <div className="container">
          ...
          {polling && <h2>Generating project set metadata report. <ClimbingBoxLoader /></h2>}
